<?php
// sidebar_bhw.php - Barangay Health Worker sidebar navigation
...
$displayName = $defaults['name'] ?? ($_SESSION['employee_name'] ?? ($_SESSION['employee_first_name'] . ' ' . $_SESSION['employee_last_name']) ?? 'BHW');
...
$needsName = empty($displayName) || $displayName === 'BHW';
...
// For example: /wbhsms-cho-koronadal/pages/management/bhw/dashboard.php -> /wbhsms-cho-koronadal/
...
<div class="mobile-topbar">
    <a href="<?= $nav_base ?>management/bhw/dashboard.php">
...
<!-- Sidebar -->
<nav class="nav" id="sidebarNav" aria-label="BHW sidebar">
    ...
    <div class="menu" role="menu">
        ...
        <a href="<?= $nav_base ?>management/bhw/patient_records_management.php"
    ...
    <a href="<?= $nav_base ?>user/bhw_profile.php"
    ...
    <div class="user-actions">
        <a href="<?= $nav_base ?>user/bhw_settings.php"><i class="fas fa-cog"></i> Settings</a>
