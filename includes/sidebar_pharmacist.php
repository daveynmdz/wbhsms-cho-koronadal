<?php
// sidebar_pharmacist.php - Pharmacist sidebar navigation
...
$displayName = $defaults['name'] ?? ($_SESSION['employee_name'] ?? ($_SESSION['employee_first_name'] . ' ' . $_SESSION['employee_last_name']) ?? 'Pharmacist');
...
$needsName = empty($displayName) || $displayName === 'Pharmacist';
...
<div class="mobile-topbar">
    <a href="<?= $nav_base ?>management/pharmacist/dashboard.php">
...
<!-- Sidebar -->
<nav class="nav" id="sidebarNav" aria-label="Pharmacist sidebar">
    ...
    <a href="<?= $nav_base ?>user/pharmacist_profile.php"
            ...
            <div class="user-info">
                ...
                <div class="user-text">
                    ...
                    <div class="user-role" style="font-size:11px;color:#b3d9ff;margin-top:2px;">
                        <i class="fas fa-pills" style="margin-right:3px;"></i><?= htmlspecialchars($role, ENT_QUOTES, 'UTF-8') ?>
                    </div>
                </div>
    ...
    <div class="user-actions">
        <a href="<?= $nav_base ?>user/pharmacist_settings.php"><i class="fas fa-cog"></i> Settings</a>
