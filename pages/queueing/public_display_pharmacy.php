...
<body>
    ...
    <script>
        ...
        function updateDisplayElements(newDoc) {
            // Update pharmacy station displays
            const pharmacyDivs = ['div1', 'div2', 'div3', 'div4'];
            pharmacyDivs.forEach(divClass => {
        ...
        // Enhanced checkNewCalls for pharmacy services
        ...
        function triggerNewCallAlert(queueCode) {
            console.log(`🔔 New pharmacy call: ${queueCode}`);
            ...
            if ('Notification' in window && Notification.permission === 'granted') {
                new Notification('New Pharmacy Call', {
                    body: `Queue ${queueCode} - Please proceed to pharmacy counter for medication`,
        ...
        window.addEventListener('message', function(event) {
            if (event.data && event.data.type === 'queueUpdate' && event.data.stationType === 'pharmacy') {
                console.log('📨 Received queue update for pharmacy station:', event.data);
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('🏥 Enhanced Pharmacy Queue Display initialized');
            updateDateTime();
