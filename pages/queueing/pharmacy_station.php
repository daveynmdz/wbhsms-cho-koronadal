...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajax'])) {
    ...
    try {
        ...
        switch ($action) {
            case 'get_queue_data':
                // Get updated queue data for pharmacy station
...
<body>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Station configuration for pharmacy station
            const stationConfig = {
                stationType: 'pharmacy',
                stationId: <?php echo json_encode($pharmacy_station['station_id'] ?? null); ?>,
                stationName: <?php echo json_encode($pharmacy_station['station_name'] ?? 'Pharmacy Station'); ?>,
            ...
            if (typeof StationManager !== 'undefined') {
                ...
                console.log('✅ Pharmacy Station Manager initialized successfully');
            } else {
