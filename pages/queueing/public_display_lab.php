...
<body>
    ...
    <script>
        ...
        // Enhanced checkNewCalls for laboratory services
        ...
        function triggerNewCallAlert(queueCode) {
            console.log(`🔔 New laboratory call: ${queueCode}`);
            ...
            if ('Notification' in window && Notification.permission === 'granted') {
                new Notification('New Laboratory Call', {
                    body: `Queue ${queueCode} - Please proceed to laboratory for sample collection`,
        ...
        function playNotificationSound() {
            try {
                ...
                oscillator.frequency.setValueAtTime(850, audioContext.currentTime + 0.1);
        ...
        window.addEventListener('message', function(event) {
            if (event.data && event.data.type === 'queueUpdate' && event.data.stationType === 'lab') {
                console.log('📨 Received queue update for laboratory station:', event.data);
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('🏥 Enhanced Laboratory Queue Display initialized');
            updateDateTime();
