...
// Get all billing stations with current assignments and queue data for CHO (facility_id = 1)
$stations_query = "
    SELECT 
        s.station_id,
        s.station_name,
...
<body>
            ...
            <div class="call-display">
                ...
                if ($current_call): ?>
                    ...
                    <div class="station-instruction">
                        #<?php echo $current_call['station_id']; ?> - <?php echo htmlspecialchars($current_call['station_name']); ?> for Billing
                    </div>
                <?php else: ?>
    ...
    <script>
        ...
        function triggerNewCallAlert(queueCode) {
            console.log(`🔔 New billing call: ${queueCode}`);
            ...
            if ('Notification' in window && Notification.permission === 'granted') {
                new Notification('New Billing Call', {
                    body: `Queue ${queueCode} - Please proceed to billing counter`,
        ...
        window.addEventListener('message', function(event) {
            if (event.data && event.data.type === 'queueUpdate' && event.data.stationType === 'billing') {
                console.log('📨 Received queue update for billing station:', event.data);
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('🏥 Enhanced Billing Public Display initialized');
            updateDateTime();
            initCarousel();
