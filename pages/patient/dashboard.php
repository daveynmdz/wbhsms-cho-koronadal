    ...
    <main class="content-wrapper">
        <section class="dashboard-header">
            ...
            <div class="dashboard-actions">
                ...
                <a href="../patient/id_card.php" class="btn btn-secondary">
        ...
        <section class="quick-actions">
            ...
            <div class="actions-grid">
                ...
                <a href="../patient/medical_record_print.php" class="action-card">
                ...
                <a href="../patient/profile.php" class="action-card">
                ...
                <a href="../patient/id_card.php" class="action-card">
