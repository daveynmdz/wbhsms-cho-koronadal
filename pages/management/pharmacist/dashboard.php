...
try {
    ...
    if (!$assignment) {
        ...
        error_log('Pharmacist Dashboard: No active staff assignment for today - allowing access with warning.');
    ...
    error_log('Pharmacist Dashboard: Staff assignment check failed: ' . $e->getMessage());
