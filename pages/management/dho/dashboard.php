...
try {
    ...
    if (!$assignment) {
        ...
        error_log('DHO Dashboard: No active staff assignment for today - allowing access with warning.');
    ...
    error_log('DHO Dashboard: Staff assignment check failed: ' . $e->getMessage());
