                ...
                <div class="modal-body">
                    <div class="card-container" style="box-shadow: none; padding: 0;">
                        ...
                        <div style="text-align: center; padding: 20px 0;">
                            <img src="../../../assets/images/user-default.png" id="patientPhoto" alt="Patient Photo" style="width: 120px; height: 120px; border-radius: 50%; object-fit: cover; border: 3px solid #17a2b8; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
