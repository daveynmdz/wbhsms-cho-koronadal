...
try {
    ...
    if (!$assignment) {
        ...
        error_log('Cashier Dashboard: No active staff assignment for today - allowing access with warning.');
    ...
    error_log('Cashier Dashboard: Staff assignment check failed: ' . $e->getMessage());
